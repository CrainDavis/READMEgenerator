...
const questions = [
  ...
  },
  {
    ...
    name: "repoName",
    message:
      "What is the NAME of your GitHub repository? (input must match the repo name EXACTLY!)",
  },
  {
    type: "input",
    name: "title",
  ...
  },
  {
    ...
    name: "description",
    message:
      "Enter a DESCRIPTION of the project. (or press ENTER key to leave blank)",
    default: function () {
      return "";
    },
  },
  {
    ...
    name: "owner",
    message:
      "Who is the OWNER of this application? (enter your full name / company name (for copyright info)",
  },
  {
    type: "input",
    name: "year",
...
function writeToFile(answers, response) {
  ...
  fs.writeFile("your-new-README.md", markdown(answers, response), function (
    err
  ) {
    if (err) {
    ...
    console.log(
      `successfully created "${answers.title}" README.md for ${answers.username}`
    );
  });
}
